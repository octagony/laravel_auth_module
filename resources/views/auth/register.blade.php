...
<body>
    <header class="w-full">
        <div class="flex justify-end gap-4 py-2 px-4">
            <a href="" class="border p-2 bg-red-400 rounded-xl text-white">Login</a>
            <a href={{ route('register') }} class="border p-2 bg-red-400 rounded-xl text-white">Register</a>
        </div>
    </header>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action={{ route('register') }} novalidate method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="name" name="name" type="text" required class="block w-full rounded-md {{ $errors->has('name') ? 'border-red-500' :'border-0' }} py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('name')
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-2">
                            <input id="email" name="email" type="email" autocomplete="email" required class="block w-full rounded-md {{ $errors->has('email') ? 'border-red-500' :'border-0' }} py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                        @error('email')
                        <div class="relative mt-1 rounded-md shadow-sm">
                            <div class="absolute inset-y-0 left-0 text-red-400 text-sm">
